  ...
  const mailOptions = {
    ...
    html: `
      <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: auto; border: 1px solid #eee; padding: 20px; border-radius: 10px;">
        <h2 style="color: #8B1F2E; text-align: center;">Application Received!</h2>
        <p>Hello,</p>
        <p>Thank you for choosing <strong>Australia Jobs Immigration</strong>. We are pleased to inform you that your application has been successfully received and is now under review.</p>
        
        <div style="background: #faf5f5; padding: 20px; border-radius: 8px; text-align: center; margin: 25px 0; border: 1px solid #A41E34;">
          <p style="margin: 0; color: #666; font-size: 14px; text-transform: uppercase; letter-spacing: 1px;">Your Application Number</p>
          <p style="margin: 10px 0 0; color: #8B1F2E; font-size: 28px; font-weight: bold;">${applicationNumber}</p>
        </div>
        
        <p>You can use this number to check your status on our portal. We will keep you updated on any progress.</p>
        
        <p style="margin-top: 30px;">Best regards,<br>
        <strong style="color: #8B1F2E;">The Australia Jobs Team</strong></p>
